...
class UMSRepository @Inject constructor(
        ...
        @Named("PagedWebService")private val pagedWebService: WebService
) {
    ...
    fun searchData(page: Int): LiveData<Resource<SearchModel>> {
        return object : NetworkResource<SearchModel>(appExecutors) {
            override fun createCall() = pagedWebService.getSearchResults("a",page,10)
